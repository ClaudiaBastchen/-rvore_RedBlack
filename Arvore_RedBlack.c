...
Arvore_RedBlack* cria_Arvore_RedBlack() {
    Arvore_RedBlack* raiz = (Arvore_RedBlack*) malloc(sizeof(Arvore_RedBlack));
...
struct NO* balancear(struct NO* H) {//nó Vermelho é sempre filho à esquerda
    if(cor(H->dir) == RED)
        H = rotacionaEsquerda(H);
...
int remove_Arvore_RedBlack(Arvore_RedBlack *raiz, int valor) {
    if(consulta_Arvore_RedBlack(raiz, valor)) {
        struct NO* h = *raiz;
...
int totalNO_Arvore_RedBlack(Arvore_RedBlack *raiz) {
    ...
    int alt_esq = totalNO_Arvore_RedBlack(&((*raiz)->esq));
    int alt_dir = totalNO_Arvore_RedBlack(&((*raiz)->dir));
...
int altura_Arvore_RedBlack(Arvore_RedBlack *raiz) {
    ...
    int alt_esq = altura_Arvore_RedBlack(&((*raiz)->esq));
    int alt_dir = altura_Arvore_RedBlack(&((*raiz)->dir));
...
void  posOrdem_Arvore_RedBlack(Arvore_RedBlack *raiz, int H) {
    ...
    if(*raiz != NULL) {
        posOrdem_Arvore_RedBlack(&((*raiz)->esq), H + 1);
        posOrdem_Arvore_RedBlack(&((*raiz)->dir), H + 1);
...
void emOrdem_Arvore_RedBlack(Arvore_RedBlack *raiz, int H) {
    ...
    if(*raiz != NULL) {
        emOrdem_Arvore_RedBlack(&((*raiz)->esq), H + 1);
        ...
        emOrdem_Arvore_RedBlack(&((*raiz)->dir), H + 1);
    }
}
...
void preOrdem_Arvore_RedBlack(Arvore_RedBlack *raiz, int H) {
    ...
    if(*raiz != NULL) {
        ...
        preOrdem_Arvore_RedBlack(&((*raiz)->esq), H + 1);
        preOrdem_Arvore_RedBlack(&((*raiz)->dir), H + 1);
    }
}
